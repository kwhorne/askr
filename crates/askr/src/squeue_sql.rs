...
extern "C" fn c_counts(
    ...
    crate::ffi::guard("squeue_sql::counts", (), || {
...
extern "C" fn c_push(
    ...
    crate::ffi::guard("squeue_sql::push", 0, || {
        let q = unsafe { crate::ffi::bytes(q, qlen) };
...
extern "C" fn c_pop(
    ...
    crate::ffi::guard("squeue_sql::pop", 0, || {
        let q = unsafe { crate::ffi::bytes(q, qlen) };
